  ...
  return (
    ...
    >
      <a
        ...
        href="https://github.com/benjaminliu5050/benjamin-portfolio"
        target="_blank"
      ...
      <a
        rel="noreferrer noopener"
        href="https://github.com/benjaminliu5050/benjamin-portfolio/issues"
        target="_blank"
        className="w-full block cursor-default py-0.5 hover:bg-ub-warm-grey hover:bg-opacity-20 mb-1.5"
      >
        <span className="ml-5">❗</span>{" "}
      ...
      <a
        rel="noreferrer noopener"
        href="https://linkedin.com/in/benjamin-liu-723350383"
        target="_blank"
        className="w-full block cursor-default py-0.5 hover:bg-ub-warm-grey hover:bg-opacity-20 mb-1.5"
      >
      ...
      <a
        rel="noreferrer noopener"
        href="https://github.com/benjaminliu5050"
        target="_blank"
        className="w-full block cursor-default py-0.5 hover:bg-ub-warm-grey hover:bg-opacity-20 mb-1.5"
      >
        <span className="ml-5">🤝</span>{" "}
      ...
      <a
        rel="noreferrer noopener"
        href="mailto:benjaminliu5050@gmail.com"
        target="_blank"
        className="w-full block cursor-default py-0.5 hover:bg-ub-warm-grey hover:bg-opacity-20 mb-1.5"
      >
        <span className="ml-5">📥</span>{" "}
